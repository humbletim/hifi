...
namespace plugins { namespace entity {
    class MeshRay : public MathPick {
    public:
        glm::vec3 origin;
        glm::vec3 direction;
        QVariantMap metadata;
        MeshRay(const glm::vec3& origin, const glm::vec3& direction, const QVariantMap& metadata = QVariantMap());
    ...
    public:
        ...
        virtual bool findRayIntersection(const MeshRay& meshRay, IntersectionResultRef& result) { return false; }
    ...
    public:
        ...
        virtual js::Graphics::ModelPointer getScriptableModel() override { return nullptr; }
        ...
        virtual bool overrideModelRenderFlags(js::Graphics::RenderFlags flagsToSet, js::Graphics::RenderFlags flagsToClear) override { return false; }
    };
}}
