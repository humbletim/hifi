...
namespace scriptable {
    ...
    public:
        ScriptableMeshPart(scriptable::ScriptableMeshPartPointer meshPartBase) : QObject(), QScriptable(), _nativeObject(meshPartBase) {}
    ...
    public slots:
        ...
        bool replaceMeshPartData(scriptable::ScriptableMeshPartPointer source, const std::vector<std::string>& attributeNames = std::vector<std::string>());
    ...
    protected:
        ...
        scriptable::ScriptableMeshPartPointer _nativeObject;
    };
}

Q_DECLARE_METATYPE(scriptable::ScriptableMeshPartPointer)
Q_DECLARE_METATYPE(std::vector<scriptable::ScriptableMeshPartPointer>)
